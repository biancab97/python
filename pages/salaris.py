...
salaris_file = 'CSV bestanden\\salarisdata.csv'
metadata_file = 'CSV bestanden\\salaris_metadata_aangepast.csv'
combined_file = 'CSV bestanden\\combined_data.csv'
...
def zet_nummer_om_naar_bedrijfsnaam(code):
    for key, value in df_metadata.iterrows():
        print(value["Title"])
        if value["Key"] == code:
            return value["Title"]
zet_nummer_om_naar_bedrijfsnaam(30500)
